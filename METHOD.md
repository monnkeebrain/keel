...
Status: v0.1.2 — protocols defined, toolchain live. Keep every section
...
is not required for 1:1 sessions. The working-copy cwd is provided by
the operator or harness. The agent does not create a git worktree as
a KEEL verb.
